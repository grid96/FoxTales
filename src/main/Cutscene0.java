...
public class Cutscene0 extends Cutscene {
	...
	public Cutscene0() {
		...
		updates0 = updates;
		text1 = new Text(Fonts.sfr36, Fonts.wrap(Fonts.sfr36, "Wach auf, Fuchs! Es ist Zeit zu gehen. Vollbringe acht gute Taten und ich gewähre dir einen Wunsch, der dir viel Macht verleiht. Und ich weiß, dass du bei dieser Aussicht nicht widerstehen kannst...", Main.width * 0.8f));
